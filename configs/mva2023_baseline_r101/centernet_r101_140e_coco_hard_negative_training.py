...
data = dict(
    train=dict(
        ...
        hard_negative_file=LIB_ROOT_DIR + '/work_dirs/centernet_r101_140e_coco_finetune/train_coco_hard_negative.json',  # ---
...
load_from = LIB_ROOT_DIR + '/work_dirs/centernet_r101_140e_coco_finetune/latest.pth'
resume_from = None
