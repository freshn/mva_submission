...
echo "###############################"
bash tools/dist_train.sh  configs/mva2023_baseline_r101/centernet_r101_140e_coco.py $GPU_NUM --cfg-options optimizer.lr=0.08
...
echo "###############################"
bash tools/dist_train.sh  configs/mva2023_baseline_r101/centernet_r101_140e_coco_finetune.py $GPU_NUM --cfg-options optimizer.lr=0.08
...
echo "###############################"
CONFIG=configs/mva2023_baseline_r101/centernet_r101_140e_coco_sample_hard_negative.py
CHECKPOINT=work_dirs/centernet_r101_140e_coco_finetune/latest.pth
NNODES=${NNODES:-1}
...
python -m torch.distributed.launch \
 ...
 hard_neg_example_tools/test_hard_neg_example.py \
    ...
    --hard-negative-file work_dirs/centernet_r101_140e_coco_finetune/train_coco_hard_negative.json \
...
echo "###############################"
bash tools/dist_train.sh  configs/mva2023_baseline_r101/centernet_r101_140e_coco_hard_negative_training.py $GPU_NUM --cfg-options optimizer.lr=0.08
...
echo "###############################"
bash tools/dist_test.sh configs/mva2023_baseline_r101/centernet_r101_140e_coco_inference.py work_dirs/centernet_r101_140e_coco_hard_negative_training/epoch_30.pth \
